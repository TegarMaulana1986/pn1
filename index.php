  ...
  <div id="login-page">
    <div class="container">
      ...
      <form class="form-login" method="post" action="proseslogin.php">
        <h2 class="form-login-heading"> <img src="pn1.png" width="150" height="150"><br>LOGIN ADMIN</h2>
        <center>
        ...
        <div class="login-wrap">
          ...
          <div class="login-social-link centered">
            ...
            <a href="login-guru.php" class="btn btn-warning" type="submit"><i class="fa fa-user"></i> PELATIH</a>
          </div>
          <div class="registration">
            <a class="" href="https://www.facebook.com/AldistaTegar/">
              Copyright &copy; Tegar Fikri Maulana
            </a>
            <br>
          </div>
