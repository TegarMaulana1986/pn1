          	...
          	<div class="row mt">
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                      ...
                      <tr>
                        ...
                        <th>Tingkatan Sabuk <i class="fa fa-sort"></i></th>
                        <th>Tahun Ajar <i class="fa fa-sort"></i></th>
                        <th>Kelas <i class="fa fa-sort"></i></th>
                        <th>Asal Sekolah <i class="fa fa-sort"></i></th>
                        <th>Nama Pelatih <i class="fa fa-sort"></i></th>
                    ...
                    <td><center><a class="btn btn-sm btn-primary tooltips" data-placement="bottom" data-original-title="Edit Kelas" href="edit-kelas.php?hal=edit-admin&kd=<?php echo $data['kode_kelas'];?>"><span class="glyphicon glyphicon-edit"></span></a>
                        <a class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-original-title="Hapus Kelas" href="hapus-kelas.php?hal=hapus&kd=<?php echo $data['kode_kelas'];?>" onclick="return confirm('Apakah anda akan menghapus <?php echo $data['kode_kelas']; ?> ?');"><span class="glyphicon glyphicon-trash"></a></center></td></tr>
                 <?php   
              } 
              ?>
                   </tbody>
